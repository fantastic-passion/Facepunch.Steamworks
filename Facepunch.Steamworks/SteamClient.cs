...
namespace Steamworks
{
    public static class SteamClient
    {
        ...
        {
            Debug.WriteLine(
                "The current Steam API DLL appears to be a modified version. Automatically not trusting it. Report to Darvell immediately.");
            return true;
        };
        ...
        public static void Init(uint appid)
        {
            ...
            if (RuntimeInformation.IsOSPlatform(OSPlatform.Windows) && !SteamApiValidator.IsValidSteamApiDll() && !InvalidSteamDllHandler())
            {
